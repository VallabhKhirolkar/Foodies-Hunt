...
function LoginForm()   // Using Functional Component
{
    ...
    return(
        ...
        <br/><br/><br/>
        <h2 td className="info">-- User Login --</h2><br/>
        <form style={{ display: "flex",
                   justifyContent: "center",alignItems: "center"}}>
            <table>
                 <tr>
                    <td className="info"><b> Enter Username : </b></td>
                    <td><input type="text" name="username" id="uname" onChange={handleInput} /><br/></td>
                </tr> 
            <br/>
            <tr>
            <td className="info"><b>Enter Password : </b></td>
        ...
        <p className="info"><b>{errmsg}</b></p>
            <br/>
            
          <a className="info" href="/Register" style={{textAlign:"center"}}><b><i>Want to Create New Account ? Click Here...</i></b></a>
