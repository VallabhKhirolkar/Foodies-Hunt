...
class Aboutus extends React.Component{
    ...
    render(){
        ...
        <div style={{backgroundImage: 
            ...
            <table>
            <br/><br/><br/>    
            <header><h1 className="info" style={{textDecorationLine: 'underline'}}>About Us</h1></header>
            <hr/>
            <br/> 

            <h1 className="info" style={{color:"Tomato",textDecorationLine: 'underline'}}> Foodies Hunt </h1>
            <br/>
               <p className="info" style={{color:"whitesmoke"}}><b>The Foodies Hunt is an online mess service system that identifies and locates nearby messes and their available menus.
